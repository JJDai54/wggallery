...
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTGD', 'Überprüfung ob die erforderliche gd Erweiterung geladen ist oder nicht');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTGD_LOADED', 'gd Erweiterung geladen');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTGD_NOTLOADED', 'gd Erweiterung ist NICHT geladen');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTGD_INFO1', 'gd Erweiterung muss verfügbar sein, ansonsten arbeiten einige Funktionen dieses Moduls NICHT');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTGD_INFO2', 'Bitte gd Erweiterung aktivieren, ansonsten arbeitet dieses Modul NICHT richtig');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTEXIF', 'Überprüfung ob die erforderliche exif Erweiterung geladen ist oder nicht');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTEXIF_LOADED', 'exif Erweiterung geladen');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTEXIF_NOTLOADED', 'exif Erweiterung ist NICHT geladen');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTEXIF_INFO1', 'exif Erweiterung muss verfügbar sein wenn Sie die Funktion Exif-Daten-Lesen verwenden wollen');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTEXIF_INFO2', 'Bitte die exif Erweiterung aktivieren, ansonsten arbeitet das Modul nicht richtig');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTEXIF_INFO3', 'Speichern der exif-Daten ist derzeit nicht aktiviert. Wenn Sie dieses Feature verwenden wollen müssen Sie die exif-Erweiterung vorher aktivieren');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTEXIF_OPTENABLED', 'Speichern der exif-Daten ist in den Moduleinstellungen aktiviert');
\define('_AM_WGGALLERY_MAINTENANCE_CHECK_EXTEXIF_OPTDISABLED', 'Speichern der exif-Daten ist in den Moduleinstellungen nicht aktiviert');
// Import
...
\define('_AM_WGGALLERY_WEIGHT_UPDATE', 'Gewicht aktualisiert');
\define('_AM_WGGALLERY_VIEW_ALBUM', 'Album anzeigen');
\define('_AM_WGGALLERY_SUBALBUMS', 'sub-Album-s');
\define('_AM_WGGALLERY_ALPHA', 'Alphabetische Sortierung');
\define('_AM_WGGALLERY_ALBUM_PARENT', 'Übergeordnetes Album');
